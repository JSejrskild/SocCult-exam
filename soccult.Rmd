...
df_baseline <- read.csv("data_wo_policies.csv")
```
...
#print text and mean
print("The mean of the baseline, the cashbonus and the cashbenefit:")
...
df_long <- pivot_longer(df_baseline, 
...
write.csv(df_expanded, "long_baseline.csv")
````
